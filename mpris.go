...
func (p *mprisPlayer) Play() *dbus.Error {
	_ = p.ap.conn.Set("pause", false)
	return nil
}
func (p *mprisPlayer) Pause() *dbus.Error {
	_ = p.ap.conn.Set("pause", true)
	return nil
}
...
func startMPRIS(ap *audioPlayer, filePath string) (*mprisService, error) {
	...
	return &mprisService{conn: conn, props: props, lastState: StatePlaying}, nil
}
